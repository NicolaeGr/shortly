  ...
  <div class="container">
    ...
    <nav>
      <div class="link_category">
        ...
        <span class="link">Link Shortening</span>
        <span class="link">Branded Links</span>
        <span class="link">Analysis</span>
      </div>
      <div class="link_category">
        <span class="title">Resources</span>
        <span class="link">Blog</span>
        <span class="link">Developers</span>
...
<style>
  ...
  footer .link_category .title {
    color: white;
    padding-bottom: 12px;
  }

  footer .link_category .link {
    font-weight: 500;
  }

  footer .link_category .link:hover {
    color: var(--color-primary-cyen);
  }

  footer .socials svg:hover path {
    fill: var(--color-primary-cyen);
  }
